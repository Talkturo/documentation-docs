...
<Columns cols={2}>
  ...
  <Card
    title="TTS Voices"
    href="/en/api-reference/tts-voices"
    icon="mic"
    cta="Open reference"
  >
    List available text-to-speech voices from all supported providers, including system and cloned voices.
  </Card>
  ...
  <Card
    ...
    cta="Open reference"
  >
    Clone a custom TTS voice from an audio sample and persist it to a workspace.
  </Card>
  ...
  <Card
    ...
    cta="Open reference"
  >
    Manage desktop sessions, prompt presets, team analytics dashboards, and sales scripts.
  </Card>

  <Card
    title="Tool Configs"
    href="/en/api-reference/tool-configs"
    icon="wrench"
    cta="Open reference"
  >
    Attach Zapier webhooks, custom HTTP webhooks, and TurboFlow workflows to assistants.
  </Card>
</Columns>
