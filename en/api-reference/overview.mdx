...
<Columns cols={2}>
  ...
  <Card
    title="CRM Calls"
    href="/en/api-reference/crm-calls"
    icon="phone-call"
    cta="Open reference"
  >
    Initiate single outbound calls with assistant routing and metadata.
  </Card>
  ...
  <Card
    ...
    cta="Open reference"
  >
    Retrieve conversation intelligence summaries with date and campaign filtering.
  </Card>
  ...
  <Card
    ...
    cta="Open reference"
  >
    Access dashboard analytics, coaching sessions, prompts, and sales scripts.
  </Card>
