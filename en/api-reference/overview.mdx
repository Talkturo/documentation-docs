...
<Columns cols={2}>
  ...
  <Card
    ...
    cta="Open reference"
  >
    Track credit usage, voice call costs, and account-level analytics across time ranges.
  </Card>
  ...
  <Card
    ...
    cta="Open reference"
  >
    Browse TTS voices, list provider models, and manage voice cloning.
  </Card>

  <Card
    title="Public Endpoints"
    href="/en/api-reference/public"
    icon="globe"
    cta="Open reference"
  >
    Trigger demo calls and generate LiveKit tokens without authentication.
  </Card>
  ...
  <Card
    ...
    cta="Open reference"
  >
    List, add, update, and remove Stripe payment methods for your account.
  </Card>
</Columns>
