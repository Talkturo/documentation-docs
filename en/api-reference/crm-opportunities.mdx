...
All CRM Opportunities endpoints require authentication. These endpoints accept either session cookie authentication or API key Bearer token authentication.
