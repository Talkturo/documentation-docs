...
| `POST` | `/api/crm/companies/{id}/contacts` | Add a contact to a company | Deprecated |
| `DELETE` | `/api/crm/companies/{id}/contacts` | Remove a contact from a company | Deprecated |
