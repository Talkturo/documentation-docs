...
CRM Companies endpoints accept both API key and session authentication. Send an `Authorization: Bearer tk_live_...` header for API key access, or use a session cookie for browser-based requests.
