...
<Columns cols={2}>
  <Card title="Credits API" href="/api-reference/credits" icon="database" cta="View endpoint reference" />
  <Card title="Authentication" href="/api-reference/authentication" icon="lock" cta="Review auth requirements" />
</Columns>