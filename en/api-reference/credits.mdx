...
`POST /api/credits/claim-grants/new-workspace` claims a one-time credit grant awarded when a new workspace is created. The grant is applied to the signed-in account.
