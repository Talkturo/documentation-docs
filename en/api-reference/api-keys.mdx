...
```bash
curl -X GET "https://app.talkturo.com/api/api-keys?accountSlug=acme-sales" \
...
```bash
curl -X POST "https://app.talkturo.com/api/api-keys" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.example" \
...
```bash
curl -X PATCH "https://app.talkturo.com/api/api-keys/9d12c4d8-4cbf-4a20-b8a2-4a3fe1d94b55" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.example" \
  -H "Content-Type: application/json" \
  -H "Accept: application/json" \
  -d '{
...
```bash
curl -X DELETE "https://app.talkturo.com/api/api-keys/9d12c4d8-4cbf-4a20-b8a2-4a3fe1d94b55" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.example" \
  -H "Accept: application/json"
```
