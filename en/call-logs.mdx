...
If you need account-level trends instead of individual call details, use the [Intelligence dashboard](/intelligence). Call Logs are best when you want to investigate a specific conversation.
...
<Columns cols={3}>
  <Card title="Intelligence dashboard" href="/intelligence" icon="bar-chart" cta="View dashboard">
    Track trends across calls, outcomes, objections, sentiment, and performance over time.
  </Card>
  <Card title="Assistants overview" href="/assistants/overview" icon="users" cta="View assistants">
    Review and manage the assistants responsible for handling inbound and outbound calls.
  </Card>
  <Card title="Campaigns overview" href="/campaigns/overview" icon="folder" cta="View campaigns">
