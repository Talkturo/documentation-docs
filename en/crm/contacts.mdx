...
Use [Companies](/en/crm/companies) to manage account-level business records linked from contacts, and [Custom fields](/en/crm/custom-fields) to capture workspace-specific data that does not fit the default schema.
...
<Columns cols={2}>
  <Card title="Companies" href="/en/crm/companies" icon="building" cta="Manage company records" />
  <Card title="Opportunities" href="/en/crm/opportunities" icon="bar-chart" cta="Track pipeline progress" />
  <Card title="Custom fields" href="/en/crm/custom-fields" icon="settings" cta="Define workspace-specific fields" />
  <Card title="Campaigns overview" href="/en/campaigns/overview" icon="rocket" cta="Manage dialing campaigns" />
</Columns>