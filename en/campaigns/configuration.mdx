...
<Columns cols={2}>
  <Card title="Campaign overview" href="/en/campaigns/overview" icon="book-open" cta="Open guide" />
  <Card title="Real-time campaign monitoring" href="/en/campaigns/realtime" icon="bar-chart" cta="View dashboard" />
</Columns>