...
<Columns cols={2}>
  <Card title="Configure campaigns" href="/campaigns/configuration" icon="settings" cta="Open guide" />
  <Card title="Monitor campaigns in real time" href="/campaigns/realtime" icon="bar-chart" cta="View dashboard" />
  <Card title="Manage CRM contacts" href="/crm/contacts" icon="users" cta="Open contacts" />
  <Card title="Choose an assistant" href="/assistants/overview" icon="bot" cta="View assistants" />
</Columns>