...
- A Talkturo account
- Access to the Talkturo dashboard at `https://app.talkturo.com`
- An API key if you plan to use the API
- A credit card if you want to purchase a phone number beyond your included credits

Your first workspace starts with 20 free credits ($10 starting balance), so you can complete the initial setup before committing to a larger spend. Additional workspaces do not receive this grant.
...
<Steps>
  <Step title="Sign up for Talkturo">
    ...
    Open `https://app.talkturo.com/signup` and create your account.

    When signup succeeds, Talkturo creates your first workspace and applies 20 free credits ($10 starting balance) automatically.
...
<Tabs>
  <Tab title="Dashboard" icon="monitor">
    ...
    Start at `https://app.talkturo.com/assistants` and click **New Assistant**.
...
<Columns cols={2}>
  <Card title="AI Assistants" icon="monitor" href="/en/assistants/overview">
    Customize assistant behavior, templates, and telephony settings.
  </Card>
  <Card title="Campaigns" icon="bar-chart" href="/en/campaigns/overview">
    Launch outbound workflows and manage call activity at scale.
  </Card>
  <Card title="CRM Integration" icon="users" href="/en/crm/contacts">
    Add contacts and company data that your assistants can use in calls.
  </Card>
  <Card title="Features" icon="book-open" href="/en/features">
