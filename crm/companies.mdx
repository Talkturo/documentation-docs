...
<Columns cols={3}>
  <Card title="Contacts" href="/crm/contacts" icon="users" cta="Open page" />
  <Card title="Opportunities" href="/crm/opportunities" icon="bar-chart" cta="Open page" />
  <Card title="Custom fields" href="/crm/custom-fields" icon="settings" cta="Open page" />
</Columns>