...
<Columns cols={3}>
  <Card title="Contacts" href="/crm/contacts" icon="users" cta="View contacts" />
  <Card title="Companies" href="/crm/companies" icon="building" cta="View companies" />
  <Card title="Intelligence" href="/intelligence" icon="bar-chart" cta="View call insights" />
</Columns>