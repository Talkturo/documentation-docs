...
<Columns cols={3}>
  <Card title="Trigger nodes" href="/turboflow/triggers-actions" icon="zap" cta="View trigger details">
    Start a flow from a webhook, integration event, or assistant tool call.
  </Card>
  <Card title="Action nodes" href="/turboflow/triggers-actions" icon="play-circle" cta="View action details">
    Send requests, update records, call contacts, and shape output for downstream steps.
  </Card>
  <Card title="Logic nodes" href="/turboflow/triggers-actions" icon="settings" cta="View logic details">
...
<Columns cols={3}>
  <Card title="Cal.com" href="/integrations" icon="calendar" cta="View integrations">
    Receive booking events and run scheduling actions.
  </Card>
  <Card title="Calendly" href="/integrations" icon="calendar" cta="View integrations">
    Start flows from invitee events and create scheduling automations.
  </Card>
  <Card title="Gmail" href="/integrations" icon="mail" cta="View integrations">
    Send email from workflow steps.
  </Card>
  <Card title="HubSpot" href="/integrations" icon="database" cta="View integrations">
    Create contacts and deals from workflow data.
  </Card>
  <Card title="Slack" href="/integrations" icon="messages-square" cta="View integrations">
    Send messages and receive event-based triggers.
  </Card>
  <Card title="Meta" href="/integrations" icon="users" cta="View integrations">
...
<Columns cols={3}>
  <Card title="Triggers and actions" href="/turboflow/triggers-actions" icon="code" cta="Open reference">
    Review available trigger, action, and logic nodes in more detail.
  </Card>
  <Card title="Integrations" href="/integrations" icon="cloud" cta="Manage connections">
    Connect external services and configure workspace integrations.
  </Card>
  <Card title="Assistant configuration" href="/assistants/configuration" icon="settings" cta="Configure assistants">
