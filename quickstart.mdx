...
<Callout kind="info">
  Some countries (e.g., Germany) require business verification before you can purchase a number. You may also need a verified business address in the number's city — the purchase dialog shows a lock icon for unverified countries and cities, with a link to start the verification process.
</Callout>
