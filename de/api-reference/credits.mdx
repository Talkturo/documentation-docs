...
| `POST` | `/api/credits/auto-reload` | API-Schlüssel oder Sitzung | Auto-Reload-Konfiguration speichern |
| `POST` | `/api/credits/claim-grants` | Nur Sitzung | Verfügbare Grants beanspruchen |
| `POST` | `/api/credits/claim-grants/new-workspace` | Nur Sitzung | Grant für neuen Workspace beanspruchen |
| `POST` | `/api/credits/welcome-bonus` | Nur Sitzung | Willkommensbonus-Guthaben beanspruchen |
...
| `POST` | `/api/credits/auto-reload` | Auto-Reload-Einstellungen aktualisieren (unterstützt auch API-Schlüssel) |
| `POST` | `/api/credits/claim-grants` | Verfügbare Guthaben-Grants beanspruchen |
| `POST` | `/api/credits/claim-grants/new-workspace` | Grant für neuen Workspace beanspruchen |
| `POST` | `/api/credits/welcome-bonus` | Willkommensbonus-Guthaben beanspruchen |
