...
<Columns cols={3}>
  <Card title="Close-AI-Übersicht" href="/de/close-ai/overview" icon="monitor" cta="Seite öffnen" />
  <Card title="Prompt-Presets" href="/de/close-ai/prompts" icon="edit" cta="Prompts verwalten" />
  <Card title="Skript-Editor" href="/de/close-ai/script-editor" icon="git-branch" cta="Skripte prüfen" />
</Columns>
