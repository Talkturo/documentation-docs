...
<Columns cols={3}>
  <Card title="Kontakte" href="/de/crm/contacts" icon="users" cta="Kontakte öffnen" />
  <Card title="Unternehmen" href="/de/crm/companies" icon="database" cta="Unternehmen öffnen" />
  <Card title="Assistent-Konfiguration" href="/de/assistants/configuration" icon="settings" cta="Assistenten konfigurieren" />
</Columns>
