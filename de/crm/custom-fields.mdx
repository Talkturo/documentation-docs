...
Assistent-Prompts können Werte benutzerdefinierter Felder sowohl aus Kontakten als auch aus Unternehmen lesen.
- Benutzerdefinierte Felder für Kontakte: `{{contact.custom.key}}`
- Benutzerdefinierte Felder für Unternehmen: `{{company.custom.key}}`

Öffne den Tab **Prompt** und verwende den CRM Variable Picker mit Strg+Leertaste, um verfügbare Variablen einzufügen.
...
Benutzerdefinierte Felder bestimmen auch, wer in eine Kampagne aufgenommen wird. Filtere Zielgruppenlisten nach Werten benutzerdefinierter Felder.
