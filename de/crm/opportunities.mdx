...
<Columns cols={3}>
  <Card title="Kontakte" href="/de/crm/contacts" icon="users" cta="Kontakte ansehen" />
  <Card title="Unternehmen" href="/de/crm/companies" icon="building" cta="Unternehmen ansehen" />
  <Card title="Intelligence" href="/de/intelligence" icon="bar-chart" cta="Call-Insights ansehen" />
</Columns>