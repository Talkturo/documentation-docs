...
Verwende [Unternehmen](/de/crm/companies), um geschäftliche Datensätze auf Unternehmensebene zu verwalten, die mit Kontakten verknüpft sind, und [benutzerdefinierte Felder](/de/crm/custom-fields), um Workspace-spezifische Daten zu erfassen, die nicht in das Standardschema passen.
...
<Columns cols={2}>
  <Card title="Unternehmen" href="/de/crm/companies" icon="building" cta="Unternehmensdatensätze verwalten" />
  <Card title="Opportunities" href="/de/crm/opportunities" icon="bar-chart" cta="Pipeline-Fortschritt verfolgen" />
  <Card title="Benutzerdefinierte Felder" href="/de/crm/custom-fields" icon="settings" cta="Workspace-spezifische Felder definieren" />
  <Card title="Kampagnenübersicht" href="/de/campaigns/overview" icon="rocket" cta="Wählkampagnen verwalten" />
</Columns>