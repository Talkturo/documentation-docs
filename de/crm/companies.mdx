...
<Columns cols={3}>
  <Card title="Kontakte" href="/de/crm/contacts" icon="users" cta="Seite öffnen" />
  <Card title="Opportunities" href="/de/crm/opportunities" icon="bar-chart" cta="Seite öffnen" />
  <Card title="Benutzerdefinierte Felder" href="/de/crm/custom-fields" icon="settings" cta="Seite öffnen" />
</Columns>