...
<Columns cols={3}>
  <Card title="TurboFlow overview" href="/turboflow/overview" icon="zap">
    See how workflow triggers, actions, and connected apps fit together.
  </Card>
  <Card title="Assistant configuration" href="/assistants/configuration" icon="settings">
    Configure functions, providers, and assistant behavior in one place.
  </Card>
  <Card title="Telephony" href="/telephony" icon="phone">
